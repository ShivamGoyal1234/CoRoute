...
export function BudgetTopNavHeader({
  tripId,
  tripTitle,
  section,
  onSectionChange,
    ...
    >
      ...
      <div className="flex items-center gap-3 shrink-0 flex-1 justify-end h-9">
        <button
          ...
          className="h-9 px-4 rounded-xl font-medium text-white transition-opacity hover:opacity-95 flex items-center gap-2"
          style={{
